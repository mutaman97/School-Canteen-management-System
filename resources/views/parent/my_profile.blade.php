...
@section('head')
    @include('layouts.backend.partials.headersection',['title'=>__('My Profile')],['prev'=> '/'])
@endsection
...
<div class="section-body">
    <h2 class="section-title">{{ __('Hi') }}, {{ Auth::guard('studentparent')->user()->student_parent ?? ''}}</h2>
        ...
        <div class="col-12 col-md-12 col-lg-5">
            <div class="card profile-widget shadow">
                <div class="profile-widget-header">
                    <img alt="image" src="{{ gravatar(Auth::guard('studentparent')->user()->email) }}" class="rounded-circle profile-widget-picture">
...
{{--                        @endif--}}
                ...
                <form method="post" class="ajaxform_with_reset" action="{{ route('parent.passup') }}">
                    @csrf
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-12">
                                ...
                                <input type="password" name="oldpassword" id="oldpassword" class="form-control"  placeholder="{{ __('Enter Old Password') }}" required="">
